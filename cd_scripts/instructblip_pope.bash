...
mkdir answer_files_POPE_instructblip_sample
seed=$1
# coco
# for type in "popular" "adversarial" "random"; do
#   python ./llava/eval/object_hallucination_vqa_instructblip.py \
#   --question-file ./POPE/output/coco/coco_pope_${type}.json \
#   --image-folder ./playground/data/val2014 \
#   --answers-file ./answer_files_POPE_instructblip_sample/instructblip_coco_pope_${type}_answers_no_cd_seed${seed}.jsonl --seed ${seed}
# done
...
#       python llava/eval/object_hallucination_vqa_instructblip.py \
#       --question-file ./POPE/output/coco/coco_pope_${type}.json \
#       --answers-file ./answer_files_POPE_instructblip_sample/instructblip_coco_pope_${type}_noisy${ND}_beta${CD_BETA}_answers${seed}.jsonl --seed ${seed} \
...
for type in "popular" "adversarial" "random"; do
  ...
  --answers-file ./answer_files_POPE_instructblip_sample/instructblip_gqa_pope_${type}_answers_no_cd_seed${seed}.jsonl --seed ${seed}
done
...
for type in "popular" "adversarial" "random"; do
  for ND in 999; do
    for CD_BETA in 1.0; do
      python llava/eval/object_hallucination_vqa_instructblip.py \
      --question-file ./POPE/output/seem/gqa/gqa_pope_seem_${type}.jsonl \
      --answers-file ./answer_files_POPE_instructblip_sample/instructblip_gqa_pope_${type}_noisy${ND}_beta${CD_BETA}_answers${seed}.jsonl --seed ${seed} \
      --use_cd --noise_delta $ND --cd_beta $CD_BETA \
      --image-folder=/mnt/workspace/visionllm/data/llava_tuning/gqa/images
    done
  done
...
for type in "popular" "adversarial" "random"; do
  ...
  --image-folder ./playground/data/val2014 \
  --answers-file ./answer_files_POPE_instructblip_sample/instructblip_aokvqa_pope_${type}_answers_no_cd_seed${seed}.jsonl --seed ${seed}
done
...
for type in "popular" "adversarial" "random"; do
  for ND in 999; do
    for CD_BETA in 1.0; do
      python llava/eval/object_hallucination_vqa_instructblip.py \
      --question-file ./POPE/output/seem/aokvqa/aokvqa_pope_seem_${type}.jsonl \
      --answers-file ./answer_files_POPE_instructblip_sample/instructblip_aokvqa_pope_${type}_noisy${ND}_beta${CD_BETA}_answers${seed}.jsonl --seed ${seed} \
      --use_cd --noise_delta $ND --cd_beta $CD_BETA \
      --image-folder=./playground/data/val2014
    done
  done
