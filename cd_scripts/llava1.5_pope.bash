...
for type in "popular" "adversarial" "random"; do
  ...
  --answers-file ./answer_files_POPE_sample/llava15_coco_pope_${type}_answers_no_cd_seed${seed}.jsonl --seed ${seed}
done
...
for type in "popular" "adversarial" "random"; do
  for ND in 999; do
    for CD_BETA in 1.0; do
      ...
      --model-path ./checkpoints/llava-v1.5-7b \
      --question-file ./POPE/output/coco/coco_pope_${type}.json \
      --answers-file ./answer_files_POPE_sample/llava15_coco_pope_${type}_noisy${ND}_beta${CD_BETA}_answers${seed}.jsonl --seed ${seed} \
